...
Every DEGORA release, newest first. The README covers how to install and use the
current version; this file is the history behind it.

Each entry says what changed and, where a fix is behavioural, what the old
behaviour was — so a reader who upgraded and saw a number move can find out why.
