    ...
    rows = [
        {
            ...
            "panel_role": "canonical_ISG",
            "locked_at": now,
            "evidence_basis": "Pre-output compact type I/II interferon-stimulated gene panel for IFN response pilot.",
            "notes": "Used only for pilot recall diagnostics; not tuned after looking at DEGORA output.",
        }
        ...
        summaries.append(
            {
                ...
                "paper_id": spec.paper_id,
                "rows": int(len(deg)),
                "top20_gold_hits": sorted(top20.intersection(IFN_GOLD_GENES)),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gold", type=Path, default=Path("data/studies/gold/ifn_isg_targets.csv"))
