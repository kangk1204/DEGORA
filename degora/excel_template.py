        ...
        [
            {
                ...
                "source_url": "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE001",
        ...
        [
            {
                ...
                "value": SCORE_VERSION,
                "what_it_does": "Fixed prioritization-score specification; not a probability.",
            },
    ...
    return pd.DataFrame(
        [
            ...
            },
            {
                ...
                "meaning": "Public URL for the paper, repository record, or deposited result table; preserved for audit links.",
            },
            {
                "column": "n_ctrl",
                "required": "recommended",
                "checked_where": "validated setting if filled",
                "meaning": "Positive whole-number biological replicate count in the control group. Missing/non-numeric counts use the documented unknown-count multiplier of 0.75.",
            },
            {
                "column": "n_treat",
                "required": "recommended",
                "checked_where": "validated setting if filled",
                "meaning": "Positive whole-number biological replicate count in the treatment group. Missing/non-numeric counts use the documented unknown-count multiplier of 0.75.",
            },
            {
                "column": "gene_column",
                "required": "yes",
